...
class FoundItemReportTests(TestCase):
    def setUp(self):
        ...
        user.save()
        self.location_category_other = Location_Category.objects.create(name='OTHER')
        self.location_category_AB = Location_Category.objects.create(name='ACADEMIC BUILDINGS')
        self.location_other = Location.objects.create(name='Other', category=self.location_category_other)
        self.location_thornton = Location.objects.create(name='Thornton Stacks', category=self.location_category_AB)
    ...
    def test_report_common_user_with_files(self):
        ...
        location_category = self.location_category_AB
        ...
        self.assertEqual(found_item.location_category, location_category)
    ...
    def test_report_failure(self):
        ...
        location_category = self.location_category_other
        ...
        # When Location is OTHER, the file should be required.
    ...
    def test_report_anonymous_invalid_file(self):
        item_name = "test item"
        description = "test description"
        location = Location.THORNTON_STACKS.value
        date = timezone.now().date()
