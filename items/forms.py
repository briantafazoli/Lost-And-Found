...
from .models import Item, Location, ItemFile, Location_Category
...
class ItemForm(ModelForm):
    files = MultipleFileField(required=False, widget=MultipleFileInput(attrs={'class': 'input-basic no-border'}))
